                ...
                <div class="col-md-10 ct-col10">
                    ...
                    <form name="frmMain" action="" method="post" enctype="multipart/form-data">
                        <div class="form-cp-main">
                            <h1 style="text-align: center;">View Complaint Form</h1>
                            <p><h3 style="text-align: center;"><?php echo $rs['cp_no']; ?></h3></p>
                            <hr>
                            ...
                            <div class="card border-light mb-3">
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-2">
                                            <label><b>ID</b></label>
                                            <input type="text" name="cp_no" id="cp_no" class="form-control form-control-sm form-width" readonly="" placeholder="CP NO." value="<?php echo $rs['cp_no']; ?>"/>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="cp_topic" id="cp_topic" readonly="" value="<?php echo $rs['cp_topic']; ?>" />
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" name="cp_topic_cat" id="cp_topic_cat" class="form-control form-control-sm" readonly="" value="<?php echo $rs['cp_topic_cat']; ?>"/><!-- Topic catagory -->
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" name="cp_status" id="cp_status" value="New complaint(Edit)" hidden=""/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="pri1" id="pri1" OnChange="resutName1(this.value);">
                                                <option><?php echo $editpriority1['cp_pri_use_name']; ?></option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="pri2" id="pri2" OnChange="resutName2(this.value);">
                                                <option><?php echo $editpriority2['cp_pri_use_name']; ?></option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="pri3" id="pri3" OnChange="resutName3(this.value);">
                                                <option><?php echo $editpriority3['cp_pri_use_name']; ?></option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="pri4" id="pri4" OnChange="resutName4(this.value);">
                                                <option><?php echo $editpriority4['cp_pri_use_name']; ?></option>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="pri5" id="pri5" OnChange="resutName5(this.value);">
                                                <option><?php echo $editpriority5['cp_pri_use_name']; ?></option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="pri6" id="pri6" OnChange="resutName6(this.value);">
                                                <option><?php echo $editpriority6['cp_pri_use_name']; ?></option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <select class="form-control" name="pri7" id="pri7" OnChange="resutName7(this.value);">
                                                <option><?php echo $editpriority7['cp_pri_use_name']; ?></option>
                                ...
                                <div class="card-body">
                                    <div class="form-row">
                                        <div class="col-md-3" id="h_username">
                                            ...
                                            <input type="text" name="cp_cus_name" id="cp_cus_name" class="form-control form-control-sm form-width"  placeholder="Customer Name" value="<?php echo $rs['cp_cus_name']; ?>"/>
                                        </div>

                                        <div class="col-md-3" id="h_cusref">
                                            <label><b>Customer Ref.</b></label>
                                            <input type="text" name="cp_cus_ref" id="cp_cus_ref" class="form-control form-control-sm form-width"  placeholder="Customer Ref." value="<?php echo $rs['cp_cus_ref']; ?>"/>
                                        </div>

                                        <div class="col-md-3" id="h_inv">
                                            <label><b>Invoice Number</b></label>
                                            <input type="text" name="cp_invoice_no" id="cp_invoice_no" class="form-control form-control-sm form-width"  placeholder="Invoice Number" value="<?php echo $rs['cp_invoice_no']; ?>"/>
                                        </div>
                                    </div><br>
                                    <div class="form-row">
                                        <div class="col-md-4" id="h_procode">
                                            <label><b>Product Code</b></label>
                                            <input type="text" name="cp_pro_code" id="cp_pro_code" class="form-control form-control-sm form-width"  placeholder="Product Code" value="<?php echo $rs['cp_pro_code']; ?>"/>
                                        </div>

                                        <div class="col-md-4" id="h_lotno">
                                            <label><b>Lot No.</b></label>
                                            <input type="text" name="cp_pro_lotno" id="cp_pro_lotno" class="form-control form-control-sm form-width"  placeholder="Lot No." value="<?php echo $rs['cp_pro_lotno']; ?>"/>
                                        </div>

                                        <div class="col-md-4" id="h_qty">
                                            <label><b>Quantity</b></label>
                                            <input type="text" name="cp_pro_qty" id="cp_pro_qty" class="form-control form-control-sm form-width"  placeholder="Quantity" value="<?php echo $rs['cp_pro_qty']; ?>"/>
                                        </div>
                                    </div><br>
                                    <div class="form-row">
                                        <div class="col-md-12 form-group">
                                            <textarea name="cp_detail" class="form-control form-control-sm" type="textarea" id="message" placeholder="Message" maxlength="2000" rows="7"><?php echo $rs['cp_detail']; ?></textarea>
